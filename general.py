...
class General(commands.Cog):
    ...
    def __init__(self, bot):
        self.bot = bot
        self.responses = json.load(open('/Users/isaiahjones/PycharmProjects/CareerBot/data/responses.json'))

        with open('/Users/isaiahjones/PycharmProjects/CareerBot/data/motivational_quotes.csv', 'r') as f:
